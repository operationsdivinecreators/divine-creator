            ...
            <section ref={sectionRef} id="process" className="mb-10">
                <div className="process-bg">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-30 gap-y-10 md:gap-y-0 relative">
                            <Xwrapper>
                        ...
                        {steps.map((_, index) => {
                            ...
                            return (
                                <Xarrow
                                    key={`arrow-${index}`}
                                    start={`process-card-${index}`}
                                    end={`process-card-${index + 1}`}
                                    startAnchor={index % 2 === 0 ? "middle" : "middle"}
                                    endAnchor={index % 2 === 0 ? "middle" : "middle"}
                                    curveness={0.7}
                                    strokeWidth={2}
                                    color="#c4a661"
                                    showHead={true}
